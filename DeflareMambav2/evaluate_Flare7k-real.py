...
def calculate_metrics(args):
    ...
    for i in tqdm(range(n)):
        ...
        ssim += calculate_ssim(img_gt, img_input,0)
        psnr += calculate_psnr(img_gt, img_input,0)
    ...
    if args['mask'] is not None:
        ...
        print(f"Score: {score_dict['score']}, G-PSNR: {score_dict['glare']}, S-PSNR: {score_dict['streak']}, Source-PSNR: {score_dict['global']}")
        

if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument('--input',type=str,default="result/Flare7k-real/deflare")
    parser.add_argument('--gt',type=str,default="testdata/Flare7k-real/gt")
    parser.add_argument('--mask',type=str,default="testdata/Flare7k-real/mask")
